...
import com.yupi.yioj.judge.codesandbox.CodeSandboxFactory;
import com.yupi.yioj.judge.codesandbox.CodeSandboxProxy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    @Resource
    private JudgeMannager judgeMannager;
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        if (!questionSubmit.getStatus().equals(QuestionSubmitStatusEnum.WAITING)) {
    ...
    questionSubmitUpdate.setStatus(QuestionSubmitStatusEnum.RUNNING.getValue());
        ...
        JudgeInfo judgeInfo = judgeMannager.doJudge(judgeContext);
        // 6) 修改数据库中的判题结果
